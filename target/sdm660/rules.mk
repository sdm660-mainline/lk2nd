...
#MEMBASE := 0x40000000 # SDRAM
#MEMBASE := 0x43400000 # this is where downstream puts initrd start
MEMBASE := 0x80000000 # There is memory here for all sdm660 devices with 3/4/6Gb RAM
MEMSIZE := 0x00400000 # 4MB

BASE_ADDR    := 0x0000000

#SCRATCH_ADDR := 0x43600000
SCRATCH_ADDR := 0x80600000
#SCRATCH_SIZE := 733
SCRATCH_SIZE := 256
